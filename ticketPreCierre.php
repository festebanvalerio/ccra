...
foreach ($lstFormaPagoEfectivo as $objFormaPago) {
    $lstHistorialPago = HistorialPagoData::getAllByReporteCierre(1, $idCaja, $fecha, "", $objFormaPago->id, 1);
    if (count($lstHistorialPago) > 0) {
        ...
        $objFormaPagoMixtaEfectivo = HistorialPagoData::getTotalXFormaPagoMixta(1, $idCaja, $fecha, "", 1);
        ...
        $lstDetalle = HistorialPagoData::getAllDescuentoXCierre($fecha, $idCaja, "", $objFormaPago->id, 1);
...
foreach ($lstFormaPagoTarjeta as $objTipoTarjeta) {
    $lstHistorialPago = HistorialPagoData::getAllByReporteCierre(1, $idCaja, $fecha, "", $objTipoTarjeta->id, 2);
    ...
    $objFormaPagoMixtaTarjeta = HistorialPagoData::getTotalXFormaPagoMixta(1, $idCaja, $fecha, "", 2, $objTipoTarjeta->id);
    ...
    $lstDetalle = HistorialPagoData::getAllDescuentoXCierre($fecha, $idCaja, "", $objTipoTarjeta->id, 2);
    foreach ($lstDetalle as $objDetalle) {
        $totalDescuento += $objDetalle->descuento;
    }
