<?php
    ...
    if ($indicador == 0) {
        ...
        for ($i = $sd; $i <= $ed; $i += (60 * 60 * 24)) {
            $lstPedido[$i] = PedidoData::getTicketMedioGroupByFecha($_SESSION["sede"], date("Y-m-d", $i), date("Y-m-d", $i));
        }
    } else if ($indicador == 1) {
        for ($i = $mesInicio; $i <= $mesFin; $i++) {
            $lstPedido[$i] = PedidoData::getTicketMedioGroupByMes($_SESSION["sede"], $anho, $i);
        }
    } else if ($indicador == 2) {
        for ($i = $anhoInicio; $i <= $anhoFin; $i++) {
            $lstPedido[$i] = PedidoData::getTicketMedioGroupByAnho($_SESSION["sede"], $i);
        }
    }
	...
	<div class="row">
		<div class="col-md-12">
			<div class="panel panel-primary">
    			<div class="panel-heading" style="background-color: #3c8dbc;"><h3 class="panel-title">Reporte Ticket Medio</h3></div>
    			<div class="panel-body">
    				<form class="form-horizontal" method="post" id="report9" action="" role="form" autocomplete="off">
        					...
        					<div class="col-md-4 col-sm-12" style="padding-top: 25px;">
        						...
        						<script type="text/javascript">
            						$("#btnLimpiar").click(function(){
            		    				...
            		    				location.href = "./index.php?view=report9";
            		    			});
	...
	<div class="box box-primary">
		<div class="box box-success">
            <div class="box-header">
    			<div class="box-title">Reporte Ticket Medio</div>
    		</div>
    		<div class="box-body">
